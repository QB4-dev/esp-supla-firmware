...
static bsp_t brd_sonoff_basic_r2 = { .id = "SONOFF-BASIC-R2",
                                     .ver = "1.3",
                                     .settings_pack = board_settings };

bsp_t *const bsp = &brd_sonoff_basic_r2;
...
esp_err_t board_supla_init(supla_dev_t *dev)
{
    ...
    status_led = supla_status_led_init(dev, GPIO_NUM_13);
...
#endif //CONFIG_BSP_SONOFF_BASICR2_v1_3
